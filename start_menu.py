...
class Menu:
    ...
    def __init__(self, screen):
        ...
        # Шрифты
        self.title_font = pygame.font.Font("font/PressStart2P-Regular.ttf", 64)  # Ретро-шрифт с пикселями
        self.option_font = pygame.font.Font("font/PressStart2P-Regular.ttf", 36)
        ...
        self.alien_image = pygame.image.load('image/alien.png')  # Изображение пришельца
        self.alien_image = pygame.transform.scale(self.alien_image, (40, 40))  # Масштабирование
        self.asteroid_image = pygame.image.load('image/asteroid_3.png')  # Изображение астероида
        self.asteroid_image = pygame.transform.scale(self.asteroid_image, (40, 40))  # Масштабирование
        self.boss_image = pygame.image.load('image/boss.png')  # Изображение босса
        self.boss_image = pygame.transform.scale(self.boss_image, (69, 57))  # Масштабирование (чуть больше)
        self.bonus_life_image = pygame.image.load('image/new_red_heart.png')  # Доп. жизни
        self.bonus_life_image = pygame.transform.scale(self.bonus_life_image, (49, 49))  # Масштабирование
        self.bonus_fast_bullets_image = pygame.image.load('image/bonus_fast_bullet.png')  # Быстрые пули
        self.bonus_fast_bullets_image = pygame.transform.scale(self.bonus_fast_bullets_image, (46, 46))  # Масштабирование
        self.bonus_shield_image = pygame.image.load('image/shield (2).png')  # Щит
    ...
    def info_menu(self):
        while True:
            ...
            # Заголовок
            title_font = pygame.font.Font("font/PressStart2P-Regular.ttf", 50)
